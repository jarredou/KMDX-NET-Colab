    ...
    def demix_base(self, mix):          
        ...
        for model in self.models:
            if model.target_name == "vocals":
                ...
                ort_session = ort.InferenceSession(f'{model_path}/{model_name}/{model.target_name}.onnx',providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
